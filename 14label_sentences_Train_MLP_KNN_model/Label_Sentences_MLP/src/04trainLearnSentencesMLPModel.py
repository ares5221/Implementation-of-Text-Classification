...
X_train = np.load(os.path.abspath('.') + '/data/X_train_learn_sentences_149342.npy')
X_test = np.load(os.path.abspath('.') + '/data/X_test_learn_sentences149342.npy')

Y_train = np.load(os.path.abspath('.') + '/data/Y_train_learn_sentences149342.npy')
Y_test = np.load(os.path.abspath('.') + '/data/Y_test_learn_sentences149342.npy')
